...
class IssuePaymentPage extends StatefulWidget {
  @override
  _IssuePaymentPageState createState() => _IssuePaymentPageState();
}

class _IssuePaymentPageState extends State<IssuePaymentPage> {
  final FirestoreService firestoreService = FirestoreService();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Authorize Payment')),
      ...
      floatingActionButton: StreamBuilder<List<DocumentSnapshot>>(
        ...
        builder: (context, snapshot) {
          ...
          return FloatingActionButton.extended(
            ...
            label: const Text('Initiate Bulk Payment'),
